...
function App() {
  ...
  const checkSpelling = async () => {
    ...
    if (!text || text.trim().length === 0) {
      showMessage('অনুগ্রহ করে টেক্সট লিখুন', 'error');
      return;
    }
      ...
      <div className="content-area">
        ...
        {!isLoading && stats.totalWords === 0 && !message && (
          <div className="empty-state">
            ...
            <p style={{fontSize: '11px', marginTop: '6px'}}>টেক্সট লিখে "পরীক্ষা করুন" ক্লিক করুন</p>
          </div>
        )}
        ...
        {stats.totalWords > 0 && (
          <div className="stats-grid">
            <div className="stat-card">
              ...
              <div className="lbl">মোট শব্দ</div>
            </div>
            <div className="stat-card">
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <ol style={{paddingLeft: '18px', lineHeight: '2', fontSize: '13px'}}>
                ...
                <li style={{marginBottom:'10px'}}>✍️ বাংলা টেক্সট লিখুন বা পেস্ট করুন</li>
                <li style={{marginBottom:'10px'}}>💬 <strong>টোন</strong> আইকনে ক্লিক করে ভাব নির্বাচন করুন</li>
                <li style={{marginBottom:'10px'}}>📝 <strong>ভাষারীতি</strong> আইকনে ক্লিক করে সাধু/চলিত নির্বাচন করুন</li>
              ...
              <div style={{marginTop: '16px', padding: '14px', background: 'linear-gradient(135deg, #fef3c7 0%, #fde68a 100%)', borderRadius: '10px', border: '2px solid #fbbf24'}}>
                <p style={{fontSize: '12px', color: '#92400e'}}><strong>💡 টিপ:</strong> টোন বা ভাষারীতি নির্বাচন ঐচ্ছিক।</p>
              </div>
            </div>
          </div>
        </div>
